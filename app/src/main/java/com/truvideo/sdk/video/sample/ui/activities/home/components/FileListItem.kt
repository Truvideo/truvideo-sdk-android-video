...
import com.truvideo.sdk.video.sample.ui.dialogs.ThumbnailDialog
...
fun FileListItem(
    ...
    var dialogThumbnailVisible by remember { mutableStateOf(false) }
...
//                )
    ...
    if (dialogVisible) {
        VideoFileDialog(
            ...
            onGetThumbnailPressed = {
                dialogVisible = false
                dialogThumbnailVisible = true
            }
        )
    }
    ...
    if (dialogThumbnailVisible) {
        ThumbnailDialog(
            path = info.path,
            close = { dialogThumbnailVisible = false },
        )
    }
