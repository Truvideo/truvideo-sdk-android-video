...
fun VideoFileDialog(
    ...
    onRemoveAudioPressed: () -> Unit = {},
    onRemoveVideoPressed: () -> Unit = {},
    ...
    if (visible) {
        BasicAlertDialog(
            ...
            Content(
                ...
                onRemoveAudioPressed = onRemoveAudioPressed,
                onClearNoisePressed = onClearNoisePressed,
                onRemoveVideoPressed = onRemoveVideoPressed,
    ...
    OptionDialogContent(
        ...
        options = persistentListOf(
            ...
            OptionDialogModel(
                ...
                onPressed = onRemoveAudioPressed
            ),
            OptionDialogModel(
                title = "Remove video",
                icon = Icons.AutoMirrored.Outlined.MissedVideoCall,
                onPressed = onRemoveVideoPressed
            ),
            OptionDialogModel(
