 ...
 * @param[out] perFrameInfo Returns voice and noise energy levels of the current frame. For BVC models it also returns cleaned secondary speech status.
 * 
 * @retval 0  success, negative on error
 */
KRISP_AUDIO_API int
 ...
 * @param[out] perFrameInfo If ringtone is false returns voice and noise energy levels of the current frame and for BVC models
 *                          it also returns cleaned secondary speech status. If ringtone is true returns 0.
 * 
 * @retval 0  success, negative on error
 */
KRISP_AUDIO_API int
