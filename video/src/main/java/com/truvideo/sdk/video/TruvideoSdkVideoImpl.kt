...
import com.truvideo.sdk.video.usecases.AddAudioTrackUseCase
import com.truvideo.sdk.video.usecases.AddVideoTrackUseCase
...
import com.truvideo.sdk.video.usecases.RemoveAudioTrackUseCase
import com.truvideo.sdk.video.usecases.RemoveVideoTrackUseCase
...
internal class TruvideoSdkVideoImpl(
    ...
    private val removeAudioTrackUseCase: RemoveAudioTrackUseCase,
    private val removeVideoTrackUseCase: RemoveVideoTrackUseCase,
    private val addAudioTrackUseCase: AddAudioTrackUseCase,
    private val addVideoTrackUseCase: AddVideoTrackUseCase,
    ...
    override fun clearNoise(
        ...
        scope.launch {
            try {
                ...
                val inputFile = File(input.getPath(context))
                val outputFile = File(output.getPath(context, inputFile.extension))
                callback.onComplete(outputFile.path)
            } catch (exception: Exception) {
                exception.printStackTrace()
...
//    override suspend fun removeAudio(
//        inputPath: String,
//        outputPath: String
//    ) {
//        removeAudioTrackUseCase(inputPath, outputPath)
//    }
//
//    override suspend fun removeVideo(
//        inputPath: String,
//        outputPath: String
//    ) {
//        removeVideoTrackUseCase(inputPath, outputPath)
//    }
//
//    override suspend fun addVideoTrack(
//        inputPath: String,
//        outputPath: String
//    ) {
//        addVideoTrackUseCase.invoke(inputPath, outputPath)
//    }
//
...
//        outputPath: String
//    ) {
//        addAudioTrackUseCase.invoke(inputPath, outputPath)
//    }
