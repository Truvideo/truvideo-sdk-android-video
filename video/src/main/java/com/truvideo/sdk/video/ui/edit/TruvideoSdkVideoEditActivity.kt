...
class TruvideoSdkVideoEditActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filePath: String = intent?.getStringExtra(INPUT_FILE_PATH_EXTRA)!!
        val outputFile: String = intent?.getStringExtra(OUTPUT_FILE_PATH_EXTRA)!!
    ...
    companion object {
        const val INPUT_FILE_PATH_EXTRA = "input_file_path_extra"
        const val OUTPUT_FILE_PATH_EXTRA = "output_file_path_extra"
    }
    ...
    private fun Content(viewModel: TruvideoSdkVideoViewModel) {
        ...
        val inputFilePath = viewModel.inputFilePath
        ...
        val exoPlayer = remember(context, inputFilePath) {
            val mediaItem = MediaItem.Builder()
                .setUri(Uri.fromFile(File(inputFilePath)))
                .build()
        ...
        LaunchedEffect(resultPath) {
            if (resultPath != null) {
                val intent = Intent()
                intent.putExtra(OUTPUT_FILE_PATH_EXTRA, resultPath)
