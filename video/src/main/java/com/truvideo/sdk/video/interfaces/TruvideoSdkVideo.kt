...
interface TruvideoSdkVideo {
    ...
    fun getAllRequests(status: TruvideoSdkVideoRequestStatus? = null, callback: TruvideoSdkVideoCallback<List<TruvideoSdkVideoRequest>>)

    fun streamAllRequests(status: TruvideoSdkVideoRequestStatus? = null): LiveData<List<TruvideoSdkVideoRequest>>

    suspend fun getRequestById(id: String): TruvideoSdkVideoRequest?

    fun getRequestById(id: String, callback: TruvideoSdkVideoCallback<TruvideoSdkVideoRequest?>)

    fun streamRequestById(id: String): LiveData<TruvideoSdkVideoRequest?>
