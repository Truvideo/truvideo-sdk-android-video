...
internal class TruvideoSdkVideoFFmpegAdapterImpl : TruvideoSdkVideoFFmpegAdapter {
    ...
    override suspend fun execute(command: String): FfmpegExecutionResult {
    ...
    override suspend fun executeArray(command: Array<String>): FfmpegExecutionResult {
        return suspendCoroutine { cont ->
            scope.launch {
                executeArrayAsync(
                    command,
    ...
    override suspend fun getInformation(path: String): TruvideoSdkVideoInformation {
        return processGetInformation(path, 0)
    }
