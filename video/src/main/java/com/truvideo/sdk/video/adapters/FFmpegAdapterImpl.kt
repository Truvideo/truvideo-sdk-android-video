...
internal class FFmpegAdapterImpl : TruvideoSdkVideoFFmpegAdapter {
    ...
    private suspend fun processGetInformation(
        ...
        try {
            ...
            if (outputLine != null) {
                throw TruvideoSdkException("Invalid output")
            }

            val durationLine = lines.firstOrNull { it.contains("Duration:") }
                ?: throw TruvideoSdkException("Video duration not found")
            val videoDuration =
            ...
            throw TruvideoSdkException("Error getting video information")
        }
    }
