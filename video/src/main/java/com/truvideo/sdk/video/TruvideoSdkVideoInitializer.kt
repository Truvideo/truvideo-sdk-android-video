...
import com.truvideo.sdk.video.usecases.PermissionUseCase
...
class TruvideoSdkVideoInitializer : Initializer<Unit> {
    ...
    companion object {
        fun init(context: Context) {
            ...
            val versionPropertiesAdapter = TruvideoSdkVideoVersionPropertiesAdapterImpl(context)
            val authAdapter = TruvideoSdkVideoAuthAdapterImpl(
                versionPropertiesAdapter = versionPropertiesAdapter
            )

            val permissionUseCase = PermissionUseCase(context)
