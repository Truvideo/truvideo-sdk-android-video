...
class TruvideoSdkVideoInitializer : Initializer<Unit> {
    ...
    companion object {
        fun init(context: Context) {
            ...
            val addAudioTrackUseCase = AddAudioTrackUseCase(
                context = context,
                ffmpegAdapter = ffmpegAdapter
            )

            val addVideoTrackUseCase = AddVideoTrackUseCase(
                context = context,
                ffmpegAdapter = ffmpegAdapter
            )

            val removeAudioTrackUseCase = RemoveAudioTrackUseCase(
                ffmpegAdapter = ffmpegAdapter
            )

            val removeVideoTrackUseCase = RemoveVideoTrackUseCase(
                ffmpegAdapter = ffmpegAdapter
            )
            ...
            TruvideoSdkVideo = TruvideoSdkVideoImpl(
                ...
                removeAudioTrackUseCase = removeAudioTrackUseCase,
                removeVideoTrackUseCase = removeVideoTrackUseCase,
                addVideoTrackUseCase = addVideoTrackUseCase,
                addAudioTrackUseCase = addAudioTrackUseCase,
                logAdapter = logAdapter
            )
        }
    }
