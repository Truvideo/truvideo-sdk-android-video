...
Java_com_truvideo_noisecancel_TruvideoNoiseCancellation_processNC(JNIEnv *env, jobject activityInstance, jbyteArray jWavData) {
...
Java_com_truvideo_noisecancel_NoiseCancelNative_processNCChunk(JNIEnv *env, jobject activityInstance, jbyteArray chunk, jint chunkLength) {
    mActivityInstance = activityInstance;
...
JNIEXPORT void JNICALL
Java_com_truvideo_noisecancel_NoiseCancelNative_globalInit(JNIEnv *env, jobject clazz, jstring workPath) {
...
JNIEXPORT void JNICALL
Java_com_truvideo_noisecancel_NoiseCancelNative_setModel(JNIEnv *env, jobject thiz, jstring configFilePath, jstring modelName) {
...
JNIEXPORT void JNICALL
Java_com_truvideo_noisecancel_NoiseCancelNative_globalDestroy(JNIEnv *env, jobject thiz) {
...
JNIEXPORT void JNICALL
Java_com_truvideo_noisecancel_NoiseCancelNative_createSession(JNIEnv *env, jobject thiz, jstring modelName) {
    const char *ch_name = env->GetStringUTFChars(modelName, nullptr);
...
JNIEXPORT void JNICALL
Java_com_truvideo_noisecancel_NoiseCancelNative_closeSession(JNIEnv *env, jobject thiz) {
